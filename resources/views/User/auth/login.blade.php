                ...
                <div class="col-md-4">
                    <div class="form-flex">
                        <div class="form-box">
                            ...
                            <div class="margin-30"></div>
                            <div class="pass-box">
                                <div class="pass-text-1">Login</div>
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group margin-btm-input-lg">
                                        <div class="input-group mb-1 @error('password') has-danger @enderror">
                                            ...
                                            <input type="password" class="form-control input-white home-input" placeholder="Scegli una password" 
                                        ...
                                        @if (Route::has('password.request'))
                                            <a class="text-unstyle" href="{{ route('password.request') }}">
                            ...
                            <div class="form-group text-center">
                                <a class="btn btn-outline-success btn-padding-65" href="{{ route('home') }}">Torna alla Home</a>
                            </div>
                        </div>
                    </div>
                </div>
